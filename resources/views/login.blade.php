  ...
  <div class="flex justify-center items-center w-screen h-screen">
    <div class="flex w-1/2 h-70% shadow-2xl rounded-lg">
      ...
      <div class="ml-16 mt-16">
        <h1 class="text-4xl text-blue-500 font-medium">Login</h1>
        <h1 class="text-2xl mt-5 text-blue-500 font-medium">Please login to continue</h1>
        <div>
          <form action="action_page.php" class="mt-2 mr-5 rounded-lg ">
            <div>
              <input type="text" placeholder="Username" name="username" class="w-96 h-12 pl-3 mt-3 rounded outline outline-1 outline-gray-500">
            </div>
            <div>
              <input type="text" placeholder="Asal" name="Asal" class="w-96 h-12 pl-3 mt-6 tex rounded outline outline-1 outline-gray-500">
            </div>
            <div>
    ...
    <div class="ml-2 bg-blue-600 flex grow rounded-xl shadow-2xl">
      <h1 class="text-white m-10 ml-16 text-5xl">Investkan</h1>
